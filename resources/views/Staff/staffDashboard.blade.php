  ...
  <header class="main-header">
    ...
    <aside class="main-sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="">
            <a href="/staffDashboard" class="list-group-item side-bar active" ><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
            <a href="/staffPatterns" class=" side-bar" ><i class="fa fa-paper-plane"></i> <span>Patterns</span></a>
            <a href="/staffMeasurements" class=" side-bar"><i class="fa fa-paperclip fa-lg mr-1"></i>Mesurements</a>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Peiris Fashion House</h3>
