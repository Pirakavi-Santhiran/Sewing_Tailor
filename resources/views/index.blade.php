...
<html lang="zxx">
<head>
<title>Sewing a Fashion Category Bootstrap Responsive Website Template  | Home :: W3layouts</title>
<!-- for-mobile-apps -->
...
<link rel="stylesheet" href="{{URL::asset("css/text-style.css")}}"> <!--Banner-text-style -->
<link href="{{URL::asset("css/style.css")}}" rel="stylesheet" type="text/css" media="all" />
<!--fonts-->
<link href="{{URL::asset("//fonts.googleapis.com/css?family=Ubuntu:300,400,500,700")}}" rel="stylesheet">
<link href="{{URL::asset("//fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" )}}"rel="stylesheet">
<!--//fonts-->
</head>
<body>
<!--banner start here-->
		   ...
		   <div class="header-main">
			...
			<nav class="navbar navbar-default">
					<div class="navbar-header">
                        ...
                        <div class="newx"><a  href="/index">Pieris Fashion House</a></div>
					</div>
					<!-- navbar-header -->
...
<div class="container">
		...
		<div class="botton-agileits">
			...
			<div class="agileits_w3layouts_call_mail">
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i>0112356644</li>
						<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:maria@example.com">perisFashion@gmail.com</a></li>
					</ul>
			</div>
		</div>  
		</div>
				...
				<div class="agile-contact-left">
					...
					<div class="address-grid">
						...
						<ul class="w3_address">
							...
							<li><i class="fa fa-mobile" aria-hidden="true"></i><span>Phone</span><br>0112356644</li>
							<li><i class="fa fa-envelope-o" aria-hidden="true"></i><span>Email</span><br><a href="mailto:info@example.com">perisFashion@gmail.com</a></li>
						</ul>
					</div>
				</div>
				<div class="clearfix"> </div>
...
<h6 class="contact-w3ls">Call <span>0112356644</span> to make an appointment</h6>
